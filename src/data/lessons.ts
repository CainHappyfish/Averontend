...
export const lessons: Lesson[] = [
  ...
  },
  {
    ...
    partLabel: '第一章',
    level: '进阶',
    title: '帮日菜搭建练习室 CRUD 后台',
    goal: '围绕小日菜的练习室委托，完成一个前端层面的 CRUD 管理系统：能登录、能查看列表、能新增编辑删除练习记录，并把流程讲清楚。',
    practiceRequiresSandbox: false,
    scriptLanguage: 'vue',
    hints: [
      '先把页面骨架搭出来：登录页、主布局、练习管理列表和表单。',
      '数据可以先放在前端本地，重点是完整体现新增、查看、编辑、删除。',
      '文案和字段围绕练习计划、曲目清单、成员安排与练习反馈展开。',
    ],
    starterCode: {
